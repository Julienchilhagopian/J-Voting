...
public class MainGUI {
    ...
    private static final Logger LOGGER = LoggerFactory
                    .getLogger(MainGUI.class.getName());
    protected final static Display display = Display.getDefault();
    protected final static Shell mainShell = new Shell(display,
                    SWT.CLOSE | SWT.RESIZE);
    protected GridData gridData = new GridData(GridData.CENTER, GridData.CENTER,
                    true, false);
    protected final static Label label = new Label(mainShell, SWT.CENTER);
    protected final static Button selectFileToReadButton = new Button(mainShell,
                    SWT.PUSH);
    protected static Button socColumnsGUIButton = new Button(mainShell,
                    SWT.PUSH);
    protected static Button soicolumnsGUIButton = new Button(mainShell,
                    SWT.PUSH);
    ...
    protected static Button socWrappedColumnsGUIButton = new Button(mainShell,
                    SWT.PUSH);
    protected static Button soiWrappedColumnsGUIButton = new Button(mainShell,
                    SWT.PUSH);
    ...
    public void displayGUI() {
        ...
        Font boldFont = new Font(label.getDisplay(),
                        new FontData("Arial", 20, SWT.BOLD));
        ...
        mainShell.setLocation(
                        (screenSize.width - mainShell.getBounds().width) / 2,
        ...
        selectFileToReadButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (fileToRead == null || fileToRead.isEmpty()) {
                    ...
                    fileExtension = fileToRead
                                    .substring(fileToRead.length() - 3);
