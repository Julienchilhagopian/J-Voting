...
public class ProfileDefaultGUI {
    ...
    private static final Logger LOGGER = LoggerFactory
                    .getLogger(ProfileDefaultGUI.class.getName());
    protected static final Display display = Display.getDefault();
    protected static final Shell mainShell = new Shell(display,
    ...
    /**
     * Displays the radio buttons to choose the layout of the profile. This
     * method works for both SOC and SOI.
     * 
    ...
    public void displayRadioButtons(String[] args) throws DuplicateValueException, EmptySetException {
        ...
        if (fileExtension.equals("soc")) {
            ...
            throw new IllegalArgumentException(
                            "The file is neither soc nor soi.");
        }
    }
    ...
    public void populateRows() throws DuplicateValueException, EmptySetException {
        ...
        for (int i = 0; i < nbAlternatives; i++) {
            ...
            item.setText(strictProfile.getIthAlternativesAsStrings(i)
                            .toArray(new String[nbAlternatives]));
    ...
    public void editStrictPreference(String arg) {
        ...
        final Shell modalShell = new Shell(display, SWT.TITLE | SWT.BORDER
