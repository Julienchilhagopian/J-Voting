...
public interface StrictProfileI extends ProfileI {
     ...
     * @return a list of strings containing the ith alternatives in the profile.
     ...
     * 
     * @param i
     * @return a list of strings of the ith alternatives of the unique
     *         preferences. If the preference doesn't have an ith alternative,
     *         it adds an empty string to the list.
     */
